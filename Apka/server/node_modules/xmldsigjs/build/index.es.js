...
import { XmlError, XE, Convert, XmlObject, XmlElement, XmlCollection, XmlAttribute, XmlNodeType, XmlChildElement, isElement, XmlBase64Converter, XmlNumberConverter } from 'xml-core';
...
class SignedXml {
    ...
    async DigestReference(doc, reference, checkHmac) {
        if (reference.Uri) {
            let objectName;
