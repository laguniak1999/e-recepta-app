var XAdES = (function (exports) {
  ...
  var Any$1 = function (_XadesObject) {
  ...
  __decorate([XmlContent()], Any$1.prototype, "Value", void 0);

  Any$1 = __decorate([XmlElement({
  ...
  var ObjectIdentifier$1 = function (_XadesObject6) {
  ...
  __decorate([XmlChildElement({
    parser: Identifier,
    required: true
  })], ObjectIdentifier$1.prototype, "Identifier", void 0);
  ...
  __decorate([XmlChildElement({
    ...
    prefix: XmlXades.DefaultPrefix,
    defaultValue: ""
  })], ObjectIdentifier$1.prototype, "Description", void 0);

  __decorate([XmlChildElement({
    parser: DocumentationReferences
  })], ObjectIdentifier$1.prototype, "DocumentationReferences", void 0);

  ObjectIdentifier$1 = __decorate([XmlElement({
    localName: XmlXades.ElementNames.ObjectIdentifier
  })], ObjectIdentifier$1);

  var CommitmentTypeQualifier = function (_Any$2) {
    _inherits(CommitmentTypeQualifier, _Any$2);
  ...
  var HexBlock = function HexBlock(BaseClass) {
    return function (_BaseClass) {
      ...
      function LocalHexBlockMixin() {
        ...
        _this3.isHexOnly = getParametersValue(parameters, "isHexOnly", false);
  ...
  var LocalIdentificationBlock = function (_HexBlock) {
    ...
    function LocalIdentificationBlock() {
      ...
      if ("idBlock" in parameters) {
        _this4.isHexOnly = getParametersValue(parameters.idBlock, "isHexOnly", false);
        _this4.valueHex = getParametersValue(parameters.idBlock, "valueHex", new ArrayBuffer(0));
        _this4.tagClass = getParametersValue(parameters.idBlock, "tagClass", -1);
        _this4.tagNumber = getParametersValue(parameters.idBlock, "tagNumber", -1);
        _this4.isConstructed = getParametersValue(parameters.idBlock, "isConstructed", false);
      } else {
        _this4.tagClass = -1;
        _this4.tagNumber = -1;
  ...
  var LocalLengthBlock = function (_LocalBaseBlock) {
    ...
    function LocalLengthBlock() {
      ...
      if ("lenBlock" in parameters) {
        _this5.isIndefiniteForm = getParametersValue(parameters.lenBlock, "isIndefiniteForm", false);
        _this5.longFormUsed = getParametersValue(parameters.lenBlock, "longFormUsed", false);
        _this5.length = getParametersValue(parameters.lenBlock, "length", 0);
      } else {
  ...
  var LocalBooleanValueBlock = function (_ValueBlock4) {
    ...
    function LocalBooleanValueBlock() {
      ...
      _this12.value = getParametersValue(parameters, "value", false);
      _this12.isHexOnly = getParametersValue(parameters, "isHexOnly", false);
  ...
  var LocalBitStringValueBlock = function (_HexBlock3) {
    ...
    function LocalBitStringValueBlock() {
      ...
      _this19.unusedBits = getParametersValue(parameters, "unusedBits", 0);
      _this19.isConstructed = getParametersValue(parameters, "isConstructed", false);
    ...
    _createClass(BitString, [{
      ...
      value: function toString() {
        if (this.valueBlock.isConstructed || this.valueBlock.value && this.valueBlock.value.length) {
          ...
          var _iterator7 = _createForOfIteratorHelper(valueHex),
              _step7;
  ...
  var Integer$1 = function (_BaseBlock8) {
    _inherits(Integer$1, _BaseBlock8);

    var _super43 = _createSuper(Integer$1);
  ...
  var LocalSidValueBlock = function (_HexBlock5) {
    ...
    function LocalSidValueBlock() {
      ...
      _this24.valueDec = getParametersValue(parameters, "valueDec", -1);
      _this24.isFirstSid = getParametersValue(parameters, "isFirstSid", false);
      return _this24;
    }
  ...
  var LocalObjectIdentifierValueBlock = function (_ValueBlock5) {
    ...
    function LocalObjectIdentifierValueBlock() {
      ...
      _this25.fromString(getParametersValue(parameters, "value", ""));
  ...
  var LocalRelativeSidValueBlock = function (_HexBlock7) {
    ...
    function LocalRelativeSidValueBlock() {
      ...
      _this29.valueDec = getParametersValue(parameters, "valueDec", -1);
      return _this29;
    }
  ...
  var LocalRelativeObjectIdentifierValueBlock = function (_ValueBlock6) {
    ...
    function LocalRelativeObjectIdentifierValueBlock() {
      ...
      _this30.fromString(getParametersValue(parameters, "value", ""));
  ...
  var RSAPrivateKey = function () {
    ...
    _createClass(RSAPrivateKey, [{
      ...
      value: function toSchema() {
        var outputArray = [];
        outputArray.push(new Integer$1({
          value: this.version
        }));
    ...
    _createClass(PBKDF2Params, [{
      ...
      value: function toSchema() {
        ...
        if ("keyLength" in this) {
          if (PBKDF2Params.defaultValues("keyLength") !== this.keyLength) outputArray.push(new Integer$1({
                ...
                case "RSAES-PKCS1-V1_5":
                  {
                    ...
                    for (var _i29 = 0, _Object$keys6 = Object.keys(_publicKeyJSON3); _i29 < _Object$keys6.length; _i29++) {
                      var _key9 = _Object$keys6[_i29];
                      jwk[_key9] = _publicKeyJSON3[_key9];
                    }
                  }
                  break;
                ...
                case "RSASSA-PKCS1-V1_5":
                  {
                    ...
                    for (var _i30 = 0, _Object$keys7 = Object.keys(privateKeyJSON); _i30 < _Object$keys7.length; _i30++) {
                ...
                case "ECDH":
                  {
                    ...
                    for (var _i31 = 0, _Object$keys8 = Object.keys(_privateKeyJSON); _i31 < _Object$keys8.length; _i31++) {
                ...
                case "RSA-OAEP":
                  {
                    ...
                    for (var _i32 = 0, _Object$keys9 = Object.keys(_privateKeyJSON2); _i32 < _Object$keys9.length; _i32++) {
                      var _key12 = _Object$keys9[_i32];
                ...
                case "RSAES-PKCS1-V1_5":
                  {
                    ...
                    for (var _i33 = 0, _Object$keys10 = Object.keys(_privateKeyJSON3); _i33 < _Object$keys10.length; _i33++) {
                      var _key13 = _Object$keys10[_i33];
                      jwk[_key13] = _privateKeyJSON3[_key13];
                    }
                  }
                  break;
      ...
      value: function decryptEncryptedContentInfo(parameters) {
        ...
        sequence = sequence.then(function (result) {
          ...
          if (parameters.encryptedContentInfo.encryptedContent.idBlock.isConstructed === false) dataBuffer = parameters.encryptedContentInfo.encryptedContent.valueBlock.valueHex;else {
            var _iterator8 = _createForOfIteratorHelper(parameters.encryptedContentInfo.encryptedContent.valueBlock.value),
                _step8;
  ...
  function createECDSASignatureFromCMS(cmsSignature) {
    ...
    if (cmsSignature.valueBlock.value[0] instanceof Integer$1 === false) return new ArrayBuffer(0);
    if (cmsSignature.valueBlock.value[1] instanceof Integer$1 === false) return new ArrayBuffer(0);
    ...
    _createClass(AttributeTypeAndValue, [{
      ...
      value: function isEqual(compareTo) {
        ...
        if (compareTo.constructor.blockName() === AttributeTypeAndValue.blockName()) {
          ...
          var _iterator9 = _createForOfIteratorHelper(stringBlockNames),
              _step9;
    ...
    _createClass(RelativeDistinguishedNames, [{
      ...
      value: function isEqual(compareTo) {
        if (compareTo instanceof RelativeDistinguishedNames) {
          ...
          var _iterator10 = _createForOfIteratorHelper(this.typesAndValues.entries()),
              _step10;
    ...
    _createClass(BasicConstraints, [{
      ...
      value: function toSchema() {
        ...
        if ("pathLenConstraint" in this) {
          if (this.pathLenConstraint instanceof Integer$1) outputArray.push(this.pathLenConstraint);else outputArray.push(new Integer$1({
      ...
      value: function toJSON() {
        ...
        if ("pathLenConstraint" in this) {
          if (this.pathLenConstraint instanceof Integer$1) object.pathLenConstraint = this.pathLenConstraint.toJSON();else object.pathLenConstraint = this.pathLenConstraint;
        }
  ...
  var GeneralSubtree = function () {
    ...
    _createClass(GeneralSubtree, [{
      ...
      value: function toSchema() {
        ...
        if (this.minimum !== 0) {
          var valueMinimum = 0;
          if (this.minimum instanceof Integer$1) valueMinimum = this.minimum;else valueMinimum = new Integer$1({
            value: this.minimum
          });
          outputArray.push(new Constructed({
            optional: true,
        ...
        if ("maximum" in this) {
          var valueMaximum = 0;
          if (this.maximum instanceof Integer$1) valueMaximum = this.maximum;else valueMaximum = new Integer$1({
            value: this.maximum
          });
          outputArray.push(new Constructed({
            optional: true,
  ...
  var AuthorityKeyIdentifier = function () {
    ...
    _createClass(AuthorityKeyIdentifier, [{
      ...
      value: function fromSchema(schema) {
        ...
        if ("authorityCertSerialNumber" in asn1.result) this.authorityCertSerialNumber = new Integer$1({
  ...
  var ByteStream = function () {
    function ByteStream() {
      ...
      for (var _i34 = 0, _Object$keys11 = Object.keys(parameters); _i34 < _Object$keys11.length; _i34++) {
        var key = _Object$keys11[_i34];
    ...
    _createClass(ByteStream, [{
      ...
      value: function findPattern(pattern) {
        ...
        for (var _i35 = 0; _i35 <= length - patternLength; _i35++) {
          var equal = true;
          var equalStart = backward ? start - patternLength - _i35 : start + _i35;
          ...
          if (equal) {
            return backward ? start - patternLength - _i35 : start + patternLength + _i35;
          }
        }
  ...
  var SeqStream = function () {
    function SeqStream() {
      ...
      for (var _i36 = 0, _Object$keys12 = Object.keys(parameters); _i36 < _Object$keys12.length; _i36++) {
        var key = _Object$keys12[_i36];
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _iterator11 = _createForOfIteratorHelper(logs);
                  _context.prev = 5;
  ...
  var SignedCertificateTimestampList = function () {
    ...
    _createClass(SignedCertificateTimestampList, [{
      ...
      value: function toSchema() {
        ...
        var _iterator12 = _createForOfIteratorHelper(this.timestamps),
            _step12;

        try {
          for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
            var _timestamp = _step12.value;
        ...
        for (var _i37 = 0, _timestampsData = timestampsData; _i37 < _timestampsData.length; _i37++) {
          var timestamp = _timestampsData[_i37];
  ...
  var CertificateTemplate = function () {
    ...
    _createClass(CertificateTemplate, [{
      ...
      value: function toSchema() {
        ...
        if ("templateMajorVersion" in this) outputArray.push(new Integer$1({
          value: this.templateMajorVersion
        }));
        if ("templateMinorVersion" in this) outputArray.push(new Integer$1({
  ...
  var CAVersion = function () {
    ...
    _createClass(CAVersion, [{
      key: "fromSchema",
      value: function fromSchema(schema) {
        if (schema.constructor.blockName() !== Integer$1.blockName()) throw new Error("Object's schema was not verified against input data for CAVersion");
  ...
  var DataObject$1 = function (_XmlSignatureObject3) {
  ...
  __decorate([XmlAttribute({
    ...
    defaultValue: ""
  })], DataObject$1.prototype, "Id", void 0);

  __decorate([XmlAttribute({
    localName: XmlSignature.AttributeNames.MimeType,
    defaultValue: ""
  })], DataObject$1.prototype, "MimeType", void 0);

  __decorate([XmlAttribute({
    localName: XmlSignature.AttributeNames.Encoding,
    defaultValue: ""
  })], DataObject$1.prototype, "Encoding", void 0);
  ...
  var XmlDsigEnvelopedSignatureTransform = function (_Transform3) {
    ...
    _createClass(XmlDsigEnvelopedSignatureTransform, [{
      ...
      value: function GetOutput() {
        ...
        for (var _i38 = 0, _signatures = signatures; _i38 < _signatures.length; _i38++) {
          var signature = _signatures[_i38];
  ...
  var KeyValue = function (_KeyInfoClause3) {
    ...
    _createClass(KeyValue, [{
      ...
      value: function OnLoadXml(element) {
        ...
        for (var _i39 = 0, _keyValueTypes = keyValueTypes; _i39 < _keyValueTypes.length; _i39++) {
          var keyValueType = _keyValueTypes[_i39];
    ...
    _createClass(SignedXml$1, [{
      ...
      value: function () {
        var _GetPublicKeys = _asyncToGenerator(regeneratorRuntime.mark(function _callee19() {
          var keys, _iterator13, _step13, kic, alg, _iterator14, _step14, cert, key, _key14;
          ...
          return regeneratorRuntime.wrap(function _callee19$(_context19) {
            while (1) {
              switch (_context19.prev = _context19.next) {
                case 0:
                  keys = [];
                  _iterator13 = _createForOfIteratorHelper(this.XmlSignature.KeyInfo.GetIterator());
                  _context19.prev = 2;
                ...
                case 4:
                  ...
                  _iterator14 = _createForOfIteratorHelper(kic.Certificates);
                  _context19.prev = 9;
      ...
      value: function () {
        var _DigestReference = _asyncToGenerator(regeneratorRuntime.mark(function _callee20(doc, reference, checkHmac) {
          var objectName, uri, found, xmlSignatureObjects, _i40, _xmlSignatureObjects, xmlSignatureObject, el, parent, _el, canonOutput, excC14N, digest;
            ...
            while (1) {
              switch (_context20.prev = _context20.next) {
                case 0:
                  ...
                  _i40 = 0, _xmlSignatureObjects = xmlSignatureObjects;

                case 7:
                  if (!(_i40 < _xmlSignatureObjects.length)) {
                    _context20.next = 22;
                    break;
                  }

                  xmlSignatureObject = _xmlSignatureObjects[_i40];
      ...
      value: function () {
        var _DigestReferences = _asyncToGenerator(regeneratorRuntime.mark(function _callee21(data) {
          var _iterator15, _step15, ref, hash;

          return regeneratorRuntime.wrap(function _callee21$(_context21) {
            while (1) {
              switch (_context21.prev = _context21.next) {
                case 0:
                  _iterator15 = _createForOfIteratorHelper(this.XmlSignature.SignedInfo.References.GetIterator());
                  _context21.prev = 1;
      ...
      value: function () {
        var _ValidateReferences = _asyncToGenerator(regeneratorRuntime.mark(function _callee23(doc) {
          var _iterator16, _step16, ref, digest, b64Digest, b64DigestValue, errText;
      ...
      value: function () {
        var _ValidateSignatureValue = _asyncToGenerator(regeneratorRuntime.mark(function _callee24(keys) {
          var signer, signedInfoCanon, _iterator17, _step17, key, ok;
  ...
  var OtherRef = function (_Any$3) {
    _inherits(OtherRef, _Any$3);
  ...
  var XMLTimeStamp = function (_Any$4) {
    _inherits(XMLTimeStamp, _Any$4);
  ...
  var ClaimedRole = function (_Any$5) {
    _inherits(ClaimedRole, _Any$5);
  ...
  var UnsignedDataObjectProperty = function (_Any$6) {
    _inherits(UnsignedDataObjectProperty, _Any$6);
  ...
  var DataObject = function (_DataObject$) {
    _inherits(DataObject, _DataObject$);

    var _super217 = _createSuper(DataObject);
  ...
  var SignedXml = function (_SignedXml$) {
    _inherits(SignedXml, _SignedXml$);

    var _super218 = _createSuper(SignedXml);
    ...
    _createClass(SignedXml, [{
      ...
      value: function LoadXml(value, useContainer) {
        _get(_getPrototypeOf(SignedXml.prototype), "LoadXml", this).call(this, value);
          ...
          return regeneratorRuntime.wrap(function _callee25$(_context25) {
            while (1) {
              switch (_context25.prev = _context25.next) {
                case 0:
                  return _context25.abrupt("return", _get(_getPrototypeOf(SignedXml.prototype), "Sign", this).apply(this, _args25));
          ...
          return regeneratorRuntime.wrap(function _callee26$(_context26) {
            while (1) {
              switch (_context26.prev = _context26.next) {
                case 0:
                  _context26.next = 2;
                  return _get(_getPrototypeOf(SignedXml.prototype), "ApplySignOptions", this).call(this, signature, algorithm, key, options);
                ...
                case 2:
                  ...
                  signingAlg = assign({}, algorithm, key.algorithm);
